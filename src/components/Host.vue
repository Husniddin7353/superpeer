<template>
    <div class="host">
        <div class="container">
            ...
            <img class="host-animation" src="@/assets/animation.png" alt="">

            <img class="host-img" src="@/assets/host.png" alt="">
        </div>
    </div>
</template>
...
.host{
    ...
    &-img{
        &:hover{
                box-shadow: 0px 20px 80px #ffd438d2;
                transition: all 0.3s;
        }
    }
